...
import com.projectW.DTO.ProdutoDTO;
import com.projectW.Services.ProdutoService;
...
public class ProdutoResource {
	...
	public ResponseEntity <Page<ProdutoDTO>> findPage(
		...
		Page<Produto> list = prodService.findByName(nomeDecoded, ids, page, linesPerPage, orderBy, direction);
